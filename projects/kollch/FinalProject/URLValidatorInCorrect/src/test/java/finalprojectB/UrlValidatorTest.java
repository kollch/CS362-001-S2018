...
public class UrlValidatorTest extends TestCase
{
    ...
    public void testIntroPartition()
    {
        // You can use this function to implement your First Partition testing
        UrlValidator url = new UrlValidator(new String[0], UrlValidator.ALLOW_ALL_SCHEMES);
        assertTrue(url.isValid("http://google.com"));
        assertTrue(url.isValid("www.google.com"));
        assertTrue(url.isValid("google.com"));
        assertFalse(url.isValid("htp://google.com"));
    }

    public void testMultPartsPartition()
    {
        // You can use this function to implement your Second Partition testing
        UrlValidator url = new UrlValidator(new String[0], UrlValidator.ALLOW_ALL_SCHEMES);
        assertTrue(url.isValid("http://google.com"));
        assertTrue(url.isValid("http://goo.gle.com"));
        assertFalse(url.isValid("http://google..com"));
        assertFalse(url.isValid("http://google."));
    }
    ...
    {
        UrlValidator url = new UrlValidator(new String[0], UrlValidator.ALLOW_ALL_SCHEMES);
        assertTrue(url.isValid("http://google.com:80"));
        assertFalse(url.isValid("http://google.com:abc"));
    }

    public void testPathPartition()
    {
        UrlValidator url = new UrlValidator(new String[0], UrlValidator.ALLOW_ALL_SCHEMES);
        assertTrue(url.isValid("http://google.com/search"));
        assertTrue(url.isValid("http://google.com/./"));
    }

    public void testExtensionPartition()
    {
        UrlValidator url = new UrlValidator(new String[0], UrlValidator.ALLOW_ALL_SCHEMES);
        assertTrue(url.isValid("http://google.com/?name=JamesDean"));
        assertFalse(url.isValid("http://google.com/[name=JamesDean"));
    }
